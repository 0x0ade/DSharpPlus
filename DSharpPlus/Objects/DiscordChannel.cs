...
namespace DSharpPlus
{
    ...
    public class DiscordChannel : SnowflakeObject
    {
        ...
        /// <returns></returns>
        public async Task<DiscordMessage> SendFile(string file_path, string file_name, string content = "", bool tts = false, Stream file_stream = null, bool file_stream_keepopen = false) => await DiscordClient.InternalUploadFile(ID, file_path, file_name, content, tts, file_stream, file_stream_keepopen);
        /// <summary>
